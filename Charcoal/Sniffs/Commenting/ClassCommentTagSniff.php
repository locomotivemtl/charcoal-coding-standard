...
/**
 * Disallows the use of comment tags for classes.
 */
class ClassCommentTagSniff extends ForbiddenTagsSniff
{
    const MESSAGE_TAG_FORBIDDEN   = '%s tag is forbidden in class comment';
    const MESSAGE_TAG_DISCOURAGED = '%s tag is discouraged in class comment';
